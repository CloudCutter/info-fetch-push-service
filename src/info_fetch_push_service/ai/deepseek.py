            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Do not simply restate or lightly paraphrase the post. "
                        "Treat the commentary as an explanation layer for a Chinese reader who may not understand X slang, finance jargon, abbreviations, memes, or implied context. "
                        "If the post contains non-obvious investment logic, technical terms, market jargon, product names, policy concepts, internet slang, abbreviations, or coded wording, explicitly explain what the key term means in plain Chinese and why it matters here. "
                        "Prioritize explaining terms such as slang, nicknames, acronyms, sector shorthand, trading shorthand, or culture-specific references whenever they are important for understanding the post. "
                        "When a term is obvious to ordinary Chinese readers, do not over-explain it. "
